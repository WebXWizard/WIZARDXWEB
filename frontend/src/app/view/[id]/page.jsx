    ...
    <div className="">
      ...
      <div className="container ">
        ...
        {productList !== null ? (
          ...
          //   <div className="row my-5 card p-2 mb-5 border border-gray-100 shadow-lg rounded-xl ">
          ...
          //         style={{ color: "teal", fontFamily: "initial" }}
          //       >
          ...
          //         style={{ color: "teal", fontFamily: "initial" }}
          //       >
          //         Price: <i className="bi bi-currency-rupee fw-bold "></i>
          //         {productList.price}
          //       </h1>
          //       <p
          //         className="py-3"
          ...
          //         <i className="bi bi-bag px-1"></i>Buy Now
          //       </button>
          //     </div>
          //   </div>
          // </div>
          <div className="relative px-4 pt-4 mx-auto lg:py-16 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full">
            <div className="max-w-xl mx-auto lg:max-w-screen-xl">
              <div className="mb-16 lg:max-w-lg lg:mb-0">
                <div className="max-w-xl mb-6">
                  <div>
                    <p className="inline-block px-4 py-2 mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-lg bg-violet-400">
                      Brand new
                    </p>
                  </div>
                  <h2 className="max-w-lg mb-2 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                    {productList.name}-{productList.category}
                  </h2>
                  <p className="text-xl font-sans-serif font-semibold text-gray-700 md:text-2xl">
                    {productList.description}
                  </p>
                  <h2 className="max-w-lg mb-2 mt-2 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                    $ {productList.price}
                  </h2>
                </div>
                <div className="flex items-center">
                  <a
                    href="/"
                    className="inline-flex items-center justify-center py-2 px-6 mr-4 font-bold tracking-wide text-black bg-orange-600 transition duration-200 rounded shadow-md focus:shadow-outline focus:outline-none"
                  >
                    Buy Now
                  </a>
                  <a
                    href="/"
                    aria-label=""
                    className="inline-flex items-center font-semibold px-6 py-2 rounded-xl transition-colors duration-200 text-deep-purple-accent-400 bg-yellow-600 hover:text-purple-800"
                  >
                    Add To Cart
                  </a>
                </div>
